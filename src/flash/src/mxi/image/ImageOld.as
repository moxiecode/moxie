...
package com.mxi.image 
{
	...
	public class ImageOld extends CleanEventDispatcher
	{
		...
		public function ImageOld(source:ByteArray) 
		{
			_source = source;
			super();
		}
		...
		public function scale(width:* = null, height:* = null, quality:* = null) : void
		{
			...
			if (info.width > ImageOld.MAX_WIDTH || info.height > ImageOld.MAX_HEIGHT) {
